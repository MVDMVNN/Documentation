...
2. Далее [**проксируем**](https://app.notion.com/p/365fbe7d3f0f8016b64fdff757a14e21?pvs=21) домены.
...
1. Делимся доступами на просмотр и редактирование к доменам с командой которая их запрашивала, и добавляем теги команды к каждому домену.