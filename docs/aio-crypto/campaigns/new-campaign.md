...
3. Выбираем тэг команды, для которой делается сетап + тэг источника, для которого делается сетап
4. Чистим все поля в выделенном блоке. Все эти значения баер сам подставляет перед запуском
5. Меняем вайт на тот, который указан в задаче
6. Меняем или оставляем оффер
